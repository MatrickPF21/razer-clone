  ...
  return (
    <article>
      <NavigationMenu className='block w-full max-w-none'>
        <NavigationMenuList className='scroll-bar-h-5px flex w-full items-center gap-12 overflow-x-auto px-4 pb-8 font-roboto text-sm sm:justify-between sm:gap-4 sm:overflow-hidden'>
...
function StaticProduct({ alt, image, link, title }: StaticProductProps) {
  return (
    <NavigationMenuItem className='w-[100px] text-center hover:text-primary'>
      <NavLink
        href={link}
